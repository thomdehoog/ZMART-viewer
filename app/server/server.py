...
1. the built viewer web page (the ``app/page/dist`` folder), and
...
# broken up; `docs/open/NEXT_STEPS.md` says what that would take.
        ...
        for (root_number, root, name), label in zip(entries, labels, strict=True):
            ...
            for index, channel_name, color, declared_range, active in found:
                ...
                if row is None:
                    ...
                    # open; see docs/open/NEXT_STEPS.md for the figures.
                    ...
                    merged[key] = {
                        **base,
                        ...
                        # single frame landing. See docs/open/NEXT_STEPS.md for the figures.
                        #
