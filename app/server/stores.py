...
# `docs/how_it_works/DATA_LAYOUT.md` asks never reaches this, because its pieces are filed in folders
...
def _count_frames(level: Path) -> int | None | _TooManyToCount:
    ...
    **What this costs, and why that is affordable.** One reading of the folder,
    ...
    read again after the first look at all. A store filed the way `docs/how_it_works/DATA_LAYOUT.md`
    ...
    if separator == "/":
        ...
        # `docs/how_it_works/DATA_LAYOUT.md` asks for precisely because it keeps the folder down to one
