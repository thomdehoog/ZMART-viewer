...
> (`docs/reviews/REVIEW_the_picture_grows_c_and_t.md`) and its verdict — do not build
...
(`docs/measured/MEASURED_stage0_c_and_t_instruments.md`): the projected synchronous
