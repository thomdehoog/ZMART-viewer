...
| serving doors | `app/server` | unchanged; already keyed off files |
| canvas component | `app/page` | exported as an embeddable component (it already speaks only HTTP to the doors) |
