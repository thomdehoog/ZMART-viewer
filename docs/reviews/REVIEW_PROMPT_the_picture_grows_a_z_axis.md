...
`claude/recent-codex-push-76q08t`), in `zmart-viewer/`:
...
5. The tail of `docs/open/FAULTS.md` — an unreproduced observation (the volume view
   brighter warm than after a reload) whose deciding instrument is part of
   this plan's test matrix.

Background if you want it: `docs/open/DECISION_finish_the_migration_to_one_live_path.md`
