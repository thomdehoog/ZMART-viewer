...
> An independent review of `docs/open/PLAN_the_picture_grows_a_z_axis.md` and its test
...
has decoded and refetches what is on screen (`app/page/src/engine.js`,
...
`docs/how_it_works/CONTRACT_the_files_the_viewer_needs.md`), or the plan's per-landing bake
...
(`docs/how_it_works/CONTRACT_the_files_the_viewer_needs.md`, "Sealing… materialized"). "L0 is
...
**What can be shown.** The two candidate mechanisms (docs/open/FAULTS.md, tail) leave
...
names in it (`{"wrote_image_in_place": true}`, `app/server/server.py:885-899`),
...
deprecated and scheduled for deletion (`docs/open/PLAN_close_the_neuroglancer_chapter.md`,
