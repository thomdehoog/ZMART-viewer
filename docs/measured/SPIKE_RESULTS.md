...
2. `npm --prefix app/page install && npm --prefix app/page run build`
...
After building, `app/page/dist/assets/` must contain a **large** (~1 MB)
`chunk_worker.bundle-*.js`, and `app/page/dist/async_computation.bundle.js` must
