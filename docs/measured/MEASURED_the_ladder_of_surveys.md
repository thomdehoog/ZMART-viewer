...
- **The manifest-refresh file still spoke the retired view names.**
  ...
  served picture", ``docs/open/DECISION_finish_the_migration_to_one_live_path.md``
...
round-trips in the publish path (``docs/measured/NOTE_the_shard_is_written_once.md``
