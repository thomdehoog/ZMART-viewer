...
> they were written before the storage decisions in `docs/how_it_works/DATA_LAYOUT.md`, and those
...
- the **viz-studio** (`zmart-viewer/`) — a normal Vite/npm React build served as
...
See `docs/history/PLAN.md` for the viewer's design and `docs/measured/SPIKE_RESULTS.md` for what the spike
