"""Find and read OME-Zarr stores, whatever shape a path holds.

Discovery, axes, channels, declared windows, voxel sizes and written
timepoints, through one reader for both zarr generations.
"""
