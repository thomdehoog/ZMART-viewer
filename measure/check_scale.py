...
It needs the viewer page built (``npm --prefix app/page run build``) and a browser,
...
reporting. ``docs/open/NEXT_STEPS.md`` explains the shape of the problem and what was done about
it.
"""
...
def report(rows: list[dict]) -> None:
    ...
    if not losing:
        ...
        print("\nSee docs/open/NEXT_STEPS.md for why this happens and what the fix is.")
