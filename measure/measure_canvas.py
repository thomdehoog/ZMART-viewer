"""Measure the cost of the storage layout `docs/how_it_works/DATA_LAYOUT.md` decides on.
...
long way from the ones quoted in `docs/how_it_works/DATA_LAYOUT.md`, the reasoning there deserves
another look.
"""
