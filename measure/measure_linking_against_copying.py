...
(``npm --prefix app/page run build``) and a browser, the same as the tests.
...
# `docs/how_it_works/LINKING_INSTEAD_OF_COPYING.md`.
#
...
def main() -> None:
    ...
    if not (VIZ / "app" / "page" / "dist" / "index.html").exists():
        print(
