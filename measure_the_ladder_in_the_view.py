...
(4, 16, 64, 256, 1024 positions, written by `backend/make_ladder_stores.py`,
...
Run it from the top of the repository, whole ladder or chosen rungs::
    ...
    python viz_studio/measure_the_ladder_in_the_view.py
    python viz_studio/measure_the_ladder_in_the_view.py 4 64
