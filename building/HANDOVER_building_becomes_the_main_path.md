...
- **This branch** (`agent/server-builds-the-picture-opus-5`): the engine
  ...
  (`PLAN_responsiveness.md`), and the independent review of what must
  change (`REVIEW_the_composer_meets_the_live_role.md`). Start with those
...
1. **Read** `PLAN_responsiveness.md` (the plan, including change zero) and
   `REVIEW_the_composer_meets_the_live_role.md` (ten findings, most severe
