...
- Read first:
  - `viz_studio/building/PROMPT_fix_the_storm_bake_catchup.md`
  - `viz_studio/building/HANDOVER_codex_storm_bake_and_client_staleness.md`
  - the last storm/catch-up sections of
    `viz_studio/building/MEASURED_the_ladder_of_surveys.md`

The central files are:

- `viz_studio/building/declare.py`
- `viz_studio/building/governed.py`
- `viz_studio/building/served.py`
- `viz_studio/backend/server.py`
- `viz_studio/frontend/scripts/patch_neuroglancer.mjs`
- `viz_studio/frontend/src/engine.js`
- `viz_studio/tests/test_a_commit_storm_under_zooming.py`
- `viz_studio/tests/test_dirty_pieces_reach_their_level.py`
- `viz_studio/building/show_a_run_growing.py`
