...
3. **The shared shader.** One program for all flat channel rows means the
...
4. **The 3D view.** The plan says the volumetric shader takes its colour as
...
5. **Auto and windows under additive.** The Auto light compares the window
...
6. **The stitched-regime label.** The plan promises the panel says why a
...
7. **What the plan forgot.** Segmentation masks, the targets layer, the
