...
(`REVIEW_the_composer_meets_the_live_role.md`, findings 1–10) catalogued
what breaks; a measured demonstration (2026-08-12,
`NOTE_live_updates_seen_on_screen.md`) showed the browser side works today
...
- The writer's L0–L5 default flip — decided, and gated on this work
  landing (`PLAN_responsiveness.md` change-zero section).
