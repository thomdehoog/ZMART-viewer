...
one image from them is the sanctioned answer that already exists in `DATA_LAYOUT.md`: an honest
...
- **It fights our own writing rule, in a way that loses data.** `DATA_LAYOUT.md` requires each
