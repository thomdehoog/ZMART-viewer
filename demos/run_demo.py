...
The built viewer page must exist first (``app/page/dist``); build it once with
...
def main(argv: list[str] | None = None) -> int:
    ...
    store = _HERE / "testdata" / "demo_store" / store_name
    ...
    open_window(
        ...
        open_from=_HERE / "testdata" / "test_stores",
        window=window,
        depth_samples=args.depth_samples,
        chrome=args.chrome,
        allow_selection=args.select,
